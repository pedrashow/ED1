...
/**
 * Implantação de lista Generica para usar nos exercicios 2 e 4 da lista
 * @author Beto
 *
 */
...
public class ListaGenerica<T> {
	...
	public boolean remove(T elemento) {
		...
		} else { //se o elemento está no meio, aponto o anterior para onde o corrente está apontando
